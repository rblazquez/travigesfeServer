...
@Component
public class PropertyLoader  implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
		...
		Booking booking = new Booking("BOOKING1", new Date(), new Date(), 2,
				new BigDecimal(33.95d), new BigDecimal(12.00),
